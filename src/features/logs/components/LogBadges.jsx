...
export function LevelBadge({ level }) {
  ...
  return (
    <div
      className="flex items-center gap-2 px-3 py-1 rounded-full text-[10px] font-black tracking-wider border transition-all"
      style={{
        color,
        backgroundColor: bg,
...
export function TypeBadge({ type }) {
  ...
  return (
    <div
      className="flex items-center gap-1.5 font-bold text-[10px] tracking-wide"
      style={{ color }}
    >
