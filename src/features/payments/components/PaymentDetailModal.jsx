    ...
    <Modal isOpen={isOpen} onClose={onClose} size="lg" showCloseButton>
      <ModalHeader>
        <div className="modal-form-header">
          <div
            className={`modal-form-header__icon ${isSuccess ? "bg-emerald-50 text-emerald-600" : "bg-rose-50 text-rose-600"}`}
          >
            <Building2 size={20} />
          </div>
          <div>
            ...
            <ModalDescription>
              Transaction details for {payment.organization_name}
            </ModalDescription>
          </div>
        </div>
      </ModalHeader>
      ...
      <ModalBody className="space-y-6">
        <div className="flex flex-col items-center justify-center p-8 bg-bg-elevated rounded-md border border-base relative overflow-hidden">
          ...
          <CreditCard
            size={120}
            className="absolute -right-8 -bottom-8 opacity-[0.03] rotate-12"
          />

          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-muted mb-3">
        ...
        <div className="space-y-4">
          ...
          <div className="modal-detail-grid">
            ...
            <DetailItem
              ...
              value={`${payment.payment_method}${payment.card_last4 ? ` (•••• ${payment.card_last4})` : ""}`}
              icon={CreditCard}
            />
            <DetailItem
        ...
        {payment.error_message && (
          <div className="bg-rose-50 border border-rose-100 rounded-md p-5 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-rose-900 leading-relaxed m-0">
                {payment.error_message}
              </p>
            </div>
          </div>
