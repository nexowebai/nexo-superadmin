...
export default function NotificationCenter({ loading, notifications = [] }) {
  ...
  return (
    <Card
      padding="none"
      className="rounded-md border-[var(--border-base)] bg-[var(--bg-surface)] shadow-sm overflow-hidden flex flex-col h-full"
    >
      <div className="p-6 flex items-center justify-between border-b border-[var(--border-base)]">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[11px] font-black text-[var(--warning)] uppercase tracking-[0.2em] opacity-80">
              Notification Center
            </p>
          </div>
        </div>
