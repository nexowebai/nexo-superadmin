...
export const MOCK_HEALTH_METRICS = [
    { label: "System Speed", value: "28ms", icon: Zap, color: "#10b981", delay: 0.1 },
    { label: "API Load", value: "Perfect", icon: Globe, color: "#3b82f6", delay: 0.2 },
    { label: "Database Sync", value: "94% Synced", icon: Database, color: "#8b5cf6", delay: 0.3 },
];
