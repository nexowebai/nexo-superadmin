    ...
    >
      ...
      <div className="org-hero__content">
        ...
        <div className="org-hero__meta">
          <span className="org-hero__code">
            <code>#{org.org_code}</code>
          </span>
          <span className="org-hero__dot">•</span>
          <span
            className={`org-hero__tier org-hero__tier--${org.subscription_tier?.toLowerCase()}`}
          >
            {org.subscription_tier} Plan
          </span>
          <span className="org-hero__dot">•</span>
          <span className="org-hero__joined">
            Joined {formatRelative(org.created_at)}
          </span>
        </div>
      </div>
