...
import { Modal, ModalHeader, ModalTitle, ModalDescription, ModalBody, ModalFooter, Button, Textarea } from '@components/ui';
            ...
            <form onSubmit={handleDisable}>
                <ModalHeader className="modal-form-header">
                    ...
                    <div className="modal-form-header__content">
                        ...
                        <ModalDescription>
                            Confirming this action for <span className="font-bold text-primary">{orgName}</span>
                        </ModalDescription>
                    </div>
                </ModalHeader>
