  ...
  return (
    <div className="space-y-1.5">
      <div className="flex justify-between text-xs font-bold uppercase tracking-wider">
        ...
        <span style={{ color: "var(--text-primary)" }}>{current} / {max}</span>
      </div>
          ...
          <div className="pt-2">
            <div className="p-4 rounded bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100/50 dark:border-blue-800/30">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-xs font-bold uppercase text-blue-600 dark:text-blue-400 tracking-wider">Renewal Intelligence</span>
              </div>
              <p className="text-sm font-black" style={{ color: "var(--text-primary)" }}>May 15, 2024</p>
              <p className="text-xs font-medium opacity-70" style={{ color: "var(--text-secondary)" }}>Expected: ${org.mrr} MRR</p>
            </div>
          </div>
        </CardContent>
      </Card>
