...
import { Building2, Mail, Calendar, MessageSquare, Eye, Check, X as XIcon } from 'lucide-react';
import { StatusBadge } from '@components/ui';
import { TableActions } from '@components/common';
import { formatDate } from '@utils/format';

export const useRequestColumns = ({ handleApprove, setRejectModal, setDetailModal }) => {
    return useMemo(() => [
        {
