...
export const MOCK_REQUESTS = [
  {
    ...
    status: "pending",
    message:
      "Looking to migrate our global operations to Nexo. Need high-scale data residency features.",
  ...
  },
  {
    ...
    status: "pending",
    message:
      "Security is our top priority. We need a custom SLA for our private cloud deployment.",
