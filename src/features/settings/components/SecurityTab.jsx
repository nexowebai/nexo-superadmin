      ...
      >
        <div className="toggle-list">
          <ToggleRow
            ...
            onChange={(val) =>
              setSettingValue("can_field_user_view_submission", val)
            }
          />
          <ToggleRow
      ...
      <div className="critical-overrides-card">
        ...
        <div className="critical-overrides-content">
          ...
          <p className="critical-overrides-desc">
            Operations here affect instance integrity and data availability
            across all organization nodes. Proceed with extreme caution as these
