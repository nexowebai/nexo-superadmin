  ...
  return (
    <div className="settings-sidebar-stack">
      <div className="system-status-card">
        ...
        <h4 className="system-status-name">{systemName}</h4>
        <div className="system-status-badge">Production v4.2</div>
      ...
      <div className="engine-status-banner">
        ...
        <div className="engine-status-content">
          ...
          <p className="engine-status-text">
            Changes synchronize across organization nodes within 45 seconds of
            state commit.
          </p>
        </div>
      </div>
