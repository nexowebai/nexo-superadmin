...
export const MOCK_PROJECTS_FULL = [
  {
    ...
    forms: [
      {
        ...
        fields_count: 24,
        created_at: "2025-11-26T07:35:33.000000Z",
        image:
      ...
      },
      {
        ...
        description: "Comprehensive household data collection",
        status: "published",
        is_active: true,
        is_duplicate: false,
        is_master: true,
        ...
        fields_count: 45,
        created_at: "2025-11-20T10:15:00.000000Z",
        image:
      ...
      },
      {
        ...
        description: "Water source and quality assessment",
        status: "published",
        is_active: true,
        is_duplicate: false,
        is_master: false,
      ...
      },
      {
        ...
        description: "Disease prevalence and health access",
        status: "draft",
        is_active: true,
        is_duplicate: false,
        is_master: false,
        submissions_count: 0,
        fields_count: 35,
        created_at: "2025-12-01T11:20:00.000000Z",
        image:
      ...
      },
      {
        ...
        name: "Feedback Form",
        description: "Community feedback collection",
        status: "published",
        is_active: true,
        is_duplicate: true,
        is_master: false,
        ...
        fields_count: 12,
        created_at: "2025-12-05T16:45:00.000000Z",
        image:
    ...
    recent_activity: [
      ...
      {
        id: "a3",
        message: "Health Risk Assessment form updated",
        created_at: "2026-01-11T14:20:00.000000Z",
        type: "form_update",
      },
      {
        id: "a4",
        message: "New team member Lucy Wambui added",
        created_at: "2026-01-10T10:00:00.000000Z",
        type: "team",
      },
      {
        id: "a5",
        message: "Water Access Survey published",
        created_at: "2026-01-09T09:15:00.000000Z",
        type: "form_publish",
      },
    ],
    timeline: [
      ...
      {
        id: "t2",
        title: "Forms Designed",
        description: "6 forms created and configured",
        date: "2025-11-26",
        status: "completed",
        type: "task",
      },
      {
        ...
        description: "12 team members assigned",
        date: "2025-12-01",
        status: "completed",
        type: "milestone",
      },
      {
        ...
        description: "Field data collection commenced",
        date: "2025-12-05",
        status: "completed",
        type: "milestone",
      },
      {
        ...
        description: "624 submissions collected",
        date: "2026-01-05",
        status: "completed",
        type: "milestone",
      },
      {
        ...
        description: "Scheduled quality assessment",
        date: "2026-01-15",
        status: "pending",
        type: "task",
      },
    ...
    documents: [
      ...
      },
      {
        ...
        type: "pdf",
        size: "1.8 MB",
        uploaded_at: "2025-11-20T14:30:00.000000Z",
      },
      {
        id: "doc3",
        ...
        type: "pptx",
        size: "5.2 MB",
        uploaded_at: "2025-11-22T09:15:00.000000Z",
      },
      {
        id: "doc4",
        ...
        type: "xlsx",
        size: "456 KB",
        uploaded_at: "2025-12-01T11:00:00.000000Z",
      },
      {
        id: "doc5",
        ...
        type: "docx",
        size: "124 KB",
        uploaded_at: "2025-11-18T16:45:00.000000Z",
      },
      {
        id: "doc6",
        name: "Progress Report Dec.pdf",
        type: "pdf",
        size: "890 KB",
        uploaded_at: "2026-01-02T10:30:00.000000Z",
      },
    ],
  },
  {
    ...
    description:
      "National agricultural data collection initiative covering crop production, livestock, and farm economics.",
    is_active: true,
  ...
  },
  {
    ...
    description:
      "School performance and student outcome tracking across primary and secondary schools.",
    is_active: false,
  ...
  },
  {
    ...
    description:
      "Comprehensive assessment of public infrastructure including roads, bridges, and public buildings.",
    is_active: true,
  ...
  },
  {
    ...
    description:
      "Regional water quality monitoring and assessment program for drinking water sources.",
    is_active: true,
  ...
  },
  {
    ...
    description:
      "National demographic data collection covering population, housing, and socioeconomic indicators.",
    is_active: false,
...
export const MOCK_SUBMISSIONS = [
  {
    ...
    location: {
      lat: -6.7924,
      lng: 39.2083,
      text: "Dar es Salaam, Kinondoni District",
    },
    data: {
  ...
  },
  {
    ...
    location: {
      lat: -6.8001,
      lng: 39.215,
      text: "Dar es Salaam, Ilala District",
    },
  ...
  },
  {
    ...
    location: {
      lat: -6.7856,
      lng: 39.2234,
      text: "Dar es Salaam, Temeke District",
    },
    data: {
      water_source: "public_tap",
      distance: "500m",
      quality: "acceptable",
    },
  },
  {
    ...
    location: {
      lat: -6.8123,
      lng: 39.2089,
      text: "Dar es Salaam, Ubungo District",
    },
    data: {
      respondent_name: "Peter Kimweri",
      age: 72,
      gender: "male",
      health_status: "poor",
    },
  },
  {
    ...
    location: {
      lat: -6.7789,
      lng: 39.1956,
      text: "Dar es Salaam, Kigamboni District",
    },
  ...
  },
  {
    ...
    location: {
      lat: -1.2921,
      lng: 36.8219,
      text: "Nairobi CBD, Central Region",
    },
    data: {
      ...
      additional_notes_desc:
        "Initial site assessment complete. All high-fidelity sensors active and synchronizing with the cloud terminal.",
    },
  },
];
...
export const MOCK_TASKS = [
  ...
  },
  {
    ...
    description:
      "Conduct training for field officers on the new Health Risk Assessment form",
    project_id: "a30617b1-3f6f-4576-83d2-60089017b1e1",
    project_name: "Urban Slum Living Conditions Assessment",
    assigned_to: {
      id: "m1",
...
export const TEMPLATE_FORMS = [
  {
    ...
    description:
      "Standard household survey template with demographic questions",
    fields_count: 45,
