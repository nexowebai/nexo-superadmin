...
function ProfileUpload({ preview, onChange, onRemove, label = 'Upload your profile photo', className }) {
        ...
        <div className={cn('profile-upload', className)}>
            <div className="profile-upload__container">
                <div className="profile-upload__preview" onClick={handleClick}>
                    {preview ? (
                        <img src={preview} alt="Profile" className="profile-upload__image" />
                    ) : (
                ...
                {preview && (
                    <button type="button" className="profile-upload__remove" onClick={onRemove}>
                        <X size={14} />
                    </button>
                )}
            </div>
