...
const Lightbox = memo(function Lightbox({
    ...
    return (
        <div className={`af-lightbox ${isOpen ? 'af-lightbox--open' : ''}`} onClick={onClose}>
            ...
            <div className="af-lightbox__content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="af-lightbox__info">
                    <div className="af-lightbox__details">
                        ...
                        <div className="af-lightbox__dots">
                            ...
                            <span className="af-lightbox__counter">{currentIndex + 1} / {items.length}</span>
                        </div>
                    </div>
                    {onAction && (
                        <button className="af-lightbox__action" onClick={() => onAction(current)}>
        ...
        <>
            ...
            >
                ...
                <div className="animated-folder__body">
                    ...
                    <div className="animated-folder__content">
                        ...
                        <div className="animated-folder__info">
                            ...
                            {subtitle && <span className="animated-folder__subtitle">{subtitle}</span>}
                        </div>
                    </div>
                </div>
                ...
                <div className="animated-folder__footer">
                    ...
                    {stats.length > 0 && (
                        <div className="animated-folder__stats" style={{ gridTemplateColumns: `repeat(${stats.length}, 1fr)` }}>
                            {stats.map((stat, i) => (
