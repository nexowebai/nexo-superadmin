                    ...
                    {selectedOptions.length === 0 ? (
                        ...
                        <div className="ds-multi-select__chips">
                            ...
                            {selectedOptions.length > 2 && (
                                <span className="ds-multi-select__more">+{selectedOptions.length - 2}</span>
                            )}
                        </div>
                    )}
                </div>
                <ChevronDown size={16} className={cn('ds-multi-select__chevron', isOpen && 'ds-multi-select__chevron--open')} />
            </button>
                                ...
                                filteredOptions.map((option) => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            value.includes(option.value) && 'ds-multi-select__option--selected'
                                        )}
