...
const EntityCard = memo(function EntityCard({
  ...
  const handleCardClick = (e) => {
    if (e.target.closest(".ds-action-menu") || e.target.closest("button"))
      return;
    onClick?.();
  };
  ...
  return (
    ...
    >
      <div className="ds-entity-card__header">
          ...
          <div className="ds-entity-card__info">
            ...
            {subtitle && (
              <div className="ds-entity-card__subtitle">
                ...
                <span>{subtitle}</span>
                {badge && (
                  <div className="ds-entity-card__badge-wrapper">{badge}</div>
                )}
              </div>
            )}
          </div>
        ...
        {actions.length > 0 && (
          <ActionMenu items={actions} className="ds-entity-card__actions" />
        )}
      </div>
