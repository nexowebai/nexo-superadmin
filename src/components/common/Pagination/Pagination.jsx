        ...
        <div className={cn('ds-pagination', className)}>
            <div className="ds-pagination__left">
                <div className="ds-pagination__per-page">
                    ...
                    <Select
                        size="sm"
                        options={PER_PAGE_OPTIONS.map(opt => ({ value: opt, label: opt.toString() }))}
                        value={perPage}
                ...
                <div className="ds-pagination__info">
                    ...
                    <span className="ds-pagination__total">of {totalItems.toLocaleString()}</span>
                </div>
            </div>
                ...
                <div className="ds-pagination__controls">
                    ...
                    <div className="ds-pagination__pages">
                        {getVisiblePages().map((page, index) => (
                            page === '...' ? (
                                <span key={`ellipsis-${index}`} className="ds-pagination__ellipsis">...</span>
                            ) : (
                                <button
                                    key={page}
                                    type="button"
                                    className={cn('ds-pagination__page', currentPage === page && 'ds-pagination__page--active')}
