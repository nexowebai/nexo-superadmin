        ...
        <div className={cn('ds-tabs', variant && `ds-tabs--${variant}`, className)}>
            {options.map((option) => (
                <button
                    ...
                    className={cn('ds-tab', value === option.value && 'active', variant && `ds-tab--${variant}`)}
                    type="button"
                >
                    ...
                    {value === option.value && (
                        <motion.div layoutId="activeTab" className="ds-tab-indicator" transition={{ type: "spring", bounce: 0.2, duration: 0.6 }} />
                    )}
                </button>
            ))}
        </div>
