...
const Card = forwardRef(({
    children, variant: variantProp = 'default', padding = 'md', hover: hoverable = false,
    className, onClick, ...props
}, ref) => {
    const validVariants = ['default', 'flat', 'outline', 'glass', 'elevated', 'pro', 'nx'];
    const variant = validVariants.includes(variantProp) ? variantProp : 'default';
