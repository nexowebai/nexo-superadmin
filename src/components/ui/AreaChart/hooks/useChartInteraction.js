...
import {
  getTooltipResolver,
  getIndexResolver,
} from "./utils/interactionResolvers";
...
export function useChartInteraction({
  ...
  const resolveTooltipFromX = useCallback(
    getTooltipResolver({ xScale, yScale, data, lines, xAccessor, bisectDate }),
    [xScale, yScale, data, lines, xAccessor, bisectDate],
  );
  const resolveIndexFromX = useCallback(
    getIndexResolver({ xScale, data, xAccessor, bisectDate }),
