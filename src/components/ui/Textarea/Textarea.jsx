  ...
  (
    ...
    return (
      <div
        className={cn(
          "ds-textarea-wrapper",
          fullWidth && "ds-textarea-wrapper--full",
          wrapperClassName,
        )}
      >
        {label && (
        ...
        <div
          className={cn(
            ...
            error && "ds-textarea-container--error",
            disabled && "ds-textarea-container--disabled",
          )}
        >
          <textarea
            ref={ref}
            ...
            aria-invalid={!!error}
            aria-describedby={
              error || hint ? `${textareaId}-message` : undefined
            }
            {...props}
          />
          {(showCount || maxLength) && (
        ...
        {(error || hint) && (
          <span
            ...
            className={cn(
              "ds-textarea-message",
              error && "ds-textarea-message--error",
            )}
          >
            {error || hint}
          </span>
