...
const CustomFilterIcon = () => (
  ...
  >
    ...
    <path
      d="M30 35H70L55 55V75L45 80V55L30 35Z"
      stroke="var(--warning)"
      strokeWidth="3"
...
export function SearchEmptyState({
  ...
  return (
    <Card
      variant="nx"
      className="flex flex-col items-center justify-center py-20 px-6 text-center animate-in fade-in zoom-in duration-300 bg-[var(--bg-surface)] border-2 border-dashed border-[var(--border-base)]"
    >
